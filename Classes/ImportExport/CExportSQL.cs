...
namespace HistoricJamaica
{
    public class CExportSQL : CImport
    {
        ...
        const string ExportFolder = @"c:\JHF_SQLTables\";

        private CSql m_SQL;
        private StreamWriter m_StreamWriter;
        private string ExportSQLTableHeaders = @"..\..\HistoricJamaica\JHF_SQLTables\";
            ...
            : base(SQL, sDataDirectory)
        {
            ...
            try
            {
                forLocalHost = MessageBox.Show("For Website?", "", MessageBoxButtons.YesNo) == DialogResult.No ? true : false;
        ...
        {
            string prefix = (firstField) ? "(" : ",";
            m_StreamWriter.Write(prefix + value.ToString().Trim());
        }
        //****************************************************************************************************************************
        ...
        private void WriteSchoolRecord(DataRow SchoolRow)
        {
            ...
            WriteValue(SchoolRow[U.School_col].ToString().Trim(), false);
        ...
        private void WriteSchoolRecordRecord(DataRow SchoolRow)
        {
            ...
            WriteValue(SchoolRow[U.Grade_col].ToString().Trim(), false);
            WriteValue(SchoolRow[U.BornDate_col].ToString().Trim(), false);
            WriteValue(SchoolRow[U.Person_col].ToString().Trim(), false);
        ...
        private void WriteCategoryValueRecord(DataRow categoryValueRow)
        {
            ...
            WriteValue(categoryValueRow[U.CategoryValueValue_col].ToString().Trim(), false);
        ...
        private void WriteCategoryRecord(DataRow categoryRow)
        {
            ...
            WriteValue(categoryRow[U.CategoryName_col].ToString().Trim(), false);
            m_StreamWriter.Write(")");
        }
        //****************************************************************************************************************************
        private void WriteBuilding()
        {
            ...
            foreach (DataRow row in buildingTbl.Rows)
            {
                ...
                CheckNotes(row, U.Notes1856Name_col);
        ...
        private void WriteBuildingRecord(DataRow buildingRow)
        {
            ...
            WriteValue(buildingRow[U.BuildingName_col].ToString().Trim(), false);
            ...
            WriteValue(buildingRow[U.Building1856Name_col].ToString().Trim(), false);
            WriteValue(buildingRow[U.Building1869Name_col].ToString().Trim(), false);
            WriteValue(buildingRow[U.Notes_col].ToString().Trim(), false);
            WriteValue(buildingRow[U.NotesCurrentOwner_col].ToString().Trim(), false);
            WriteValue(buildingRow[U.Notes1856Name_col].ToString().Trim(), false);
            WriteValue(buildingRow[U.Notes1869Name_col].ToString().Trim(), false);
            WriteValue(buildingRow[U.BuildingValueOrder1856Name_col].ToInt(), false);
            ...
            WriteValue(buildingRow[U.QRCode_col].ToString().Trim(), false);
            WriteValue(buildingRow[U.Then1_col].ToString().Trim(), false);
            WriteValue(buildingRow[U.Then2_col].ToString().Trim(), false);
            WriteValue(buildingRow[U.Now1_col].ToString().Trim(), false);
            WriteValue(buildingRow[U.Now2_col].ToString().Trim(), false);
            WriteValue(buildingRow[U.Then1Title_col].ToString().Trim(), false);
            WriteValue(buildingRow[U.Then2Title_col].ToString().Trim(), false);
            WriteValue(buildingRow[U.Now1Title_col].ToString().Trim(), false);
            WriteValue(buildingRow[U.Now2Title_col].ToString().Trim(), false);
            m_StreamWriter.Write(")");
        }
        //****************************************************************************************************************************
        ...
        {
            CreateTable("article");
            DataTable articleTbl = SQL.GetAllArticles();
            bool firstRow = true;
            foreach (DataRow articleRow in articleTbl.Rows)
            {
                FirstRow(ref firstRow);
                WriteValue(articleRow[U.ArticleID_col].ToInt(), true);
                WriteValue(articleRow[U.Article_col].ToString().Trim(), false);
                WriteValue(articleRow[U.ArticleContinueID_col].ToInt(), false);
                m_StreamWriter.Write(")");
            }
            m_StreamWriter.WriteLine(";");
        }
        ...
        private void WriteBuildingValueRecord(DataRow buildingValueRow)
        {
            ...
            WriteValue(buildingValueRow[U.BuildingValueValue_col].ToString().Trim(), false);
        ...
        private void WriteModernRoadValueRecord(DataRow modernRoadValueRow)
        {
            ...
            WriteValue(modernRoadValueRow[U.ModernRoadValueValue_col].ToString().Trim(), false);
            ...
            WriteValue(modernRoadValueRow[U.JRoadName_col].ToString().Trim(), false);
            WriteValue(modernRoadValueRow[U.HistoricRoad_col].ToString().Trim(), false);
            m_StreamWriter.Write(")");
        }
        //****************************************************************************************************************************
        private void WriteGrandListHistory()
        {
            CreateTable("grandlisthistory");
            DataTable grandListHistoryTbl = SQL.GetAllGrandListHistory();
            bool firstRow = true;
            foreach (DataRow row in grandListHistoryTbl.Rows)
            {
                FirstRow(ref firstRow);
                WriteGrandListHistoryRecord(row);
            }
            m_StreamWriter.WriteLine(";");
        }
        //****************************************************************************************************************************
        private void WriteGrandListHistoryRecord(DataRow grandListRow)
        {
            WriteValue(grandListRow[U.GrandListID_col].ToInt(), true);
            WriteValue(grandListRow[U.Year_col].ToInt(), false);
            WriteValue(grandListRow[U.Name1_col].ToString().Trim(), false);
            WriteValue(grandListRow[U.Name2_col].ToString().Trim(), false);
            m_StreamWriter.Write(")");
        }
        //****************************************************************************************************************************
        ...
        {
            WriteValue(grandListRow[U.GrandListID_col].ToInt(), true);
            WriteValue(grandListRow[U.TaxMapID_col].ToString().Trim(), false);
            WriteValue(grandListRow[U.StreetName_col].ToString().Trim(), false);
        ...
        private void WritePhotoRecord(DataRow Photo_row)
        {
            ...
            WriteValue(Photo_row[U.PhotoName_col].ToString().Trim(), false);
            WriteValue(Photo_row[U.PhotoExtension_col].ToString().Trim(), false);
            WriteValue(Photo_row[U.PhotoNotes_col].ToString().Trim().Trim(), false);
            WriteValue(Photo_row[U.PhotoYear_col].ToInt(), false);
            WriteValue(Photo_row[U.PhotoSource_col].ToString().Trim(), false);
        ...
        private void WriteMarriageRecords(DataRow row)
        {
            ...
            WriteValue(row[U.Divorced_col].ToString().Trim(), false);
            m_StreamWriter.Write(")");
        }
        //****************************************************************************************************************************
        ...
        private void WritePersonBuilding(DataRow Person_row)
        {
            ...
            int buildingId = Person_row[U.BuildingID_col].ToInt();
            WriteValue(personID, true);
            WriteValue(Person_row[U.SpouseLivedWithID_col].ToInt(), false);
            string notes = Person_row[U.Notes_col].ToString().Trim();
            Int64 censusYears = Person_row[U.CensusYears_col].ToInt64();
            if (censusYears != 0)
            {
                Census census = new Census();
                census.LoadCensusData(censusYears);
                string str1 = census.OccupantString(personID, true);
                string str2 = census.StringOfCensusYears();
                if (!String.IsNullOrEmpty(str2))
                {
                    str1 = str1 + " " + str2;
                }
                notes = str1.Trim() + " " + notes;
            }
            WriteValue(notes.Trim(), false);
            WriteValue(Person_row[U.BuildingValueOrder_col].ToInt(), false);
            WriteValue(buildingId, false);
            m_StreamWriter.Write(")");
        }
        //****************************************************************************************************************************
        ...
        {
            WriteValue(row[U.NameSpelling1_Col].ToString().Trim(), true);
            WriteValue(row[U.NameSpelling2_Col].ToString().Trim(), false);
            m_StreamWriter.Write(")");
        }
        //****************************************************************************************************************************
        ...
        private void WriteAllPersonsCW(DataTable PersonCW_tbl)
        {
            ...
            {
                CheckNotes(row, U.Notes_col);
                string sFullName = SQL.BuildNameLastNameFirst(row[U.FirstName_col].ToString().Trim(),
                                                      row[U.MiddleName_col].ToString().Trim(),
                                                      row[U.LastName_col].ToString().Trim(),
                                                      "", "", "", "");
        ...
        private void WritePersonCW(DataRow PersonCW_row)
        {
            ...
            WriteValue(PersonCW_row[U.FirstName_col].ToString().Trim(), false);
            WriteValue(PersonCW_row[U.MiddleName_col].ToString().Trim(), false);
            WriteValue(PersonCW_row[U.LastName_col].ToString().Trim(), false);
            WritePersonCWVitalRecords(PersonCW_row, personId);
            WriteValue(PersonCW_row[U.EnlistmentDate_col].ToString().Trim(), false);
            WriteValue(CapitalizeFirstChar(PersonCW_row[U.CemeteryName_col].ToString().Trim()), false);
        ...
        private void WriteDataMilitary(string dataMilitary)
        {
            ...
            try
            {
                ...
                OutputValues.Add(CreditedTo(ref dataMilitary));
                OutputValues.Add(Service(ref dataMilitary));
                ...
                {
                    ParseRemainingStr(OutputValues, DataMilitaryBeforeTrTo);
                }
                if (!string.IsNullOrEmpty(TransferToStr))
                {
                    OutputValues.Add(TransferToStr);
                }
                if (!string.IsNullOrEmpty(dataMilitary))
                {
                    ParseRemainingStr(OutputValues, dataMilitary);
                }
                foreach (string str in OutputValues)
                {
                    outString += str.Trim();
                    if (outString[outString.Length - 1] == ',' || outString[outString.Length - 1] == ';')
                    {
            ...
            {
                outString += ParseException(ex.Message);
            }
            outString = outString.Remove(outString.Length - 1);
            WriteValue(outString.Trim(), false);
        }
        //****************************************************************************************************************************
        private void ParseRemainingStr(ArrayList OutputValues, string remainingStr)
        {
            string criptic, actual;
            int startIndex = GetNextValue(0, remainingStr, out criptic, out actual);
            if (startIndex > 0)
            {
                string outString = remainingStr.Substring(0, startIndex).Trim();

                remainingStr = remainingStr.Substring(startIndex).Trim();
                startIndex = 0;
            }
            while (startIndex >= 0)
            {
                string newCriptic, newActual;
                int endIndex = GetNextValue(criptic.Length, remainingStr, out newCriptic, out newActual);
                if (endIndex > 0)
                {
                    string outString = remainingStr.Substring(0, endIndex).Trim();
                    remainingStr = remainingStr.Substring(endIndex);
                    outString = outString.Replace(criptic, actual);
                    OutputValues.Add(outString);
                    criptic = newCriptic;
                    actual = newActual;
                }
                startIndex = endIndex;
            ...
            {
                if (!string.IsNullOrEmpty(criptic))
                {
                    remainingStr = remainingStr.Replace(criptic, actual);
                }
                OutputValues.Add(remainingStr);
            }
        }
        //****************************************************************************************************************************
        private int GetNextValue(int startIndex, string remainingStr, out string criptic, out string actual)
        {
            criptic = "";
            actual = "";
            int index = startIndex;
            while (index < remainingStr.Length - 2)
            {
                string first = remainingStr.Substring(index, 3).ToLower();
                switch (first)
                {
                    case "pr ":
                        criptic = "pr ";
                    ...
                    case @"d/d":
                        ...
                        return index;
                    case @"dis":
                        first = remainingStr.Substring(index, 7).ToLower();
                        if (first == "dis/dsb")
                        {
                            criptic = first;
                            actual = "Discharged Disabled";
                        }
                        else if (first == "dis/wds")
                        {
                            criptic = first;
                            actual = "Discharged Wounded";
                        }
                        else
                        {
                            criptic = "dis";
        ...
        //****************************************************************************************************************************
        private string ParseException(string dataMilitary)
        {
            if (string.IsNullOrEmpty(dataMilitary))
            {
                return "!";
        ...
        private string Service(ref string dataMilitary)
        {
            ...
            returnString = returnString.Replace("enl", "Enlisted");
            returnString = returnString.Replace("m/i", "Mustered In");
            returnString = returnString.Replace("comn", "Commissioned");
        ...
        private string TransferTo(ref string dataMilitary, out string DataMilitaryBeforeTrTo)
        {
            ...
            returnString = returnString.Insert(0, "Transfered To");
        ...
        private void WritePersonCWVitalRecords(DataRow PersonCW_row, int personId)
        {
            ...
            string bornDate = PersonCW_row[U.BornDate_col].ToString().Trim();
            string diedDate = PersonCW_row[U.DiedDate_col].ToString().Trim();
        ...
        private void WriteAllPersons(DataTable Person_tbl)
        {
            ...
            foreach (DataRow row in Person_tbl.Rows)
            {
                ...
                string sFullName = SQL.BuildNameLastNameFirst(row[U.FirstName_col].ToString().Trim(),
                                                      row[U.MiddleName_col].ToString().Trim(),
                                                      row[U.LastName_col].ToString().Trim(),
                                                      row[U.Suffix_col].ToString().Trim(),
                                                      row[U.Prefix_col].ToString().Trim(),
                                                      row[U.MarriedName_col].ToString().Trim(),
                                                      row[U.KnownAs_col].ToString().Trim());
                row[sFullName_col] = sFullName;
            }
            try
            {
                ...
                for (int iSortOrder = 0; iSortOrder < num; iSortOrder++)
                {
                    ...
                    if (!Person_row[U.ExcludeFromSite_col].ToBool() &&
                        Person_row[U.FirstName_col].ToString().Trim().Length != 0 &&
                       (Person_row[U.MarriedName_col].ToString().Trim().Length != 0 ||
                        Person_row[U.LastName_col].ToString().Trim().Length != 0))
                    {
                        rowNumber++;
                        if (rowNumber > 4000)
                        {
                                 ...
                                 int iSortOrder)
        {
            ...
            WriteValue(Person_row[U.FirstName_col].ToString().Trim(), false);
            WriteValue(Person_row[U.MiddleName_col].ToString().Trim(), false);
            WriteValue(Person_row[U.LastName_col].ToString().Trim(), false);
            WriteValue(Person_row[U.MarriedName_col].ToString().Trim(), false);
            WriteValue(Person_row[U.MarriedName2_col].ToString().Trim(), false);
            WriteValue(Person_row[U.MarriedName3_col].ToString().Trim(), false);
            WriteValue(Person_row[U.KnownAs_col].ToString().Trim(), false);
            WriteValue(Person_row[U.Suffix_col].ToString().Trim(), false);
            WriteValue(Person_row[U.Prefix_col].ToString().Trim(), false);
            WriteValue(Person_row[U.FatherID_col].ToInt(), false);
            WriteValue(Person_row[U.MotherID_col].ToInt(), false);
            WriteValue(Person_row[U.Notes_col].ToString().Trim().Trim(), false);
            WriteValue(Person_row[U.Source_col].ToString().Trim(), false);
            WriteValue(Person_row[U.Sex_col].ToString().Trim(), false);
            ...
            WriteValue(Person_row[U.Census1950_col].ToInt(), false);
            m_StreamWriter.Write(")");
        }
        //****************************************************************************************************************************
        private void WritePersonVitalRecords(DataRow Person_row)
        {
            ...
            VitalRecord(VitalRecord_tbl, CemeteryRecord_tbl, Person_row, EVitalRecordType.eBirthMale, EVitalRecordType.eBirthFemale,
                        Person_row[U.BornDate_col].ToString().Trim(), Person_row[U.BornPlace_col].ToString().Trim(),
                        Person_row[U.BornHome_col].ToString().Trim(), Person_row[U.BornBook_col].ToString().Trim(),
                        Person_row[U.BornPage_col].ToString().Trim(), Person_row[U.BornSource_col].ToString().Trim());
            VitalRecord(VitalRecord_tbl, CemeteryRecord_tbl, Person_row, EVitalRecordType.eDeathMale, EVitalRecordType.eDeathFemale,
                        Person_row[U.DiedDate_col].ToString().Trim(), Person_row[U.DiedPlace_col].ToString().Trim(),
                        Person_row[U.DiedHome_col].ToString().Trim(), Person_row[U.DiedBook_col].ToString().Trim(),
                        Person_row[U.DiedPage_col].ToString().Trim(), Person_row[U.DiedSource_col].ToString().Trim());
            VitalRecord(VitalRecord_tbl, CemeteryRecord_tbl, Person_row, EVitalRecordType.eBurial, EVitalRecordType.eSearch,
                        Person_row[U.BuriedDate_col].ToString().Trim(), Person_row[U.BuriedPlace_col].ToString().Trim(),
                        Person_row[U.BuriedStone_col].ToString().Trim(), Person_row[U.BuriedBook_col].ToString().Trim(),
                        Person_row[U.BuriedPage_col].ToString().Trim(), Person_row[U.BuriedSource_col].ToString().Trim());
        }
        //****************************************************************************************************************************
        ...
        {
            string notes = row[str_col].ToString().Trim();
            ...
            if (notesString != null)
            {
                row[str_col] = notesString.ToString().Trim();
            }
        }
        //****************************************************************************************************************************
        private void WriteAllCemeteryRecords(DataTable CemeteryRecord_tbl)
        {
            ...
            foreach (DataRow row in CemeteryRecord_tbl.Rows)
            {
                ...
                string sFullName = SQL.BuildNameLastNameFirst(row[U.FirstName_col].ToString().Trim(),
                                                      ...
                                                      row[U.Suffix_col].ToString().Trim(),
                                                      row[U.Prefix_col].ToString().Trim(),
                                                      row[U.SpouseLastName_col].ToString().Trim(),
                                                      knownAs);
                row[sFullName_col] = sFullName;
            }
            try
            {
                ...
                for (int iSortOrder = 0; iSortOrder < num; iSortOrder++)
                {
                    ...
                    if (row[U.FirstName_col].ToString().Trim().Length != 0 &&
                        row[U.LastName_col].ToString().Trim().Length != 0)
                    {
                        FirstRow(ref firstRow);
                                      ...
                                      int iSortOrder)
        {
            ...
            WriteValue(row[U.FirstName_col].ToString().Trim(), false);
            WriteValue(row[U.MiddleName_col].ToString().Trim(), false);
            WriteValue(row[U.LastName_col].ToString().Trim(), false);
            WriteValue(row[U.SpouseLastName_col].ToString().Trim(), false);
            WriteValue("", false);
            WriteValue(row[U.Suffix_col].ToString().Trim(), false);
            WriteValue(row[U.Prefix_col].ToString().Trim(), false);

            WriteValue(row[U.SpouseFirstName_col].ToString().Trim(), false);
            WriteValue(row[U.SpouseMiddleName_col].ToString().Trim(), false);
            WriteValue(row[U.SpouseLastName_col].ToString().Trim(), false);
            WriteValue(row[U.SpouseSuffix_col].ToString().Trim(), false);
            WriteValue(row[U.SpousePrefix_col].ToString().Trim(), false);

            WriteValue(row[U.FatherFirstName_col].ToString().Trim(), false);
            WriteValue(row[U.FatherMiddleName_col].ToString().Trim(), false);
            WriteValue(row[U.FatherLastName_col].ToString().Trim(), false);
            WriteValue(row[U.FatherSuffix_col].ToString().Trim(), false);
            WriteValue(row[U.FatherPrefix_col].ToString().Trim(), false);

            WriteValue(row[U.MotherFirstName_col].ToString().Trim(), false);
            WriteValue(row[U.MotherMiddleName_col].ToString().Trim(), false);
            WriteValue(row[U.MotherLastName_col].ToString().Trim(), false);
            WriteValue(row[U.MotherSuffix_col].ToString().Trim(), false);
            WriteValue(row[U.MotherPrefix_col].ToString().Trim(), false);

            WriteValue(row[U.Sex_col].ToString().Trim(), false);
            WriteValue(row[U.Notes_col].ToString().Trim(), false);
            WriteValue(row[U.Epitaph_col].ToString().Trim(), false);

            //sBornDate = U.VitalRecordBornDate(EVitalRecordType.eBurial, row);
            WriteValue(row[U.BornDate_col].ToString().Trim(), false);
            WriteValue(row[U.DiedDate_col].ToString().Trim(), false);
            string cemeteryName = U.CemeteryName((Cemetery)row[U.CemeteryID_col].ToInt());
            WriteValue(U.AbbreviatedDeathInfo(EVitalRecordType.eBurial, cemeteryName, row[U.LotNumber_col].ToString().Trim(), row[U.BornDate_col].ToString().Trim(),
                        row[U.AgeYears_col].ToInt(), row[U.AgeMonths_col].ToInt(), row[U.AgeDays_col].ToInt()), false);
            WriteValue(row[U.Disposition_col].ToString().Trim(), false);
        ...
        private static string GetPersonBornDate(DataTable personTbl, int personId)
        {
            ...
            return (results.Length == 0) ? "" : results[0][U.BornDate_col].ToString().Trim();
        }
        //****************************************************************************************************************************
            ...
            foreach (DataRow row in VitalRecord_tbl.Rows)
            {
                try
                {
                    ...
                    string sFullName = SQL.BuildNameLastNameFirst(row[U.FirstName_col].ToString().Trim(),
                                                          ...
                                                          knownAs);
                    row[sFullName_col] = sFullName;
                    row[U.CemeteryName_col] = U.AbbreviatedDeathInfo(vitalRecordType, row[U.CemeteryName_col].ToString().Trim(), row[U.LotNumber_col].ToString().Trim(), row[U.BornDate_col].ToString().Trim(),
            ...
            try
            {
                ...
                for (int iSortOrder = 0; iSortOrder < num; iSortOrder++)
                {
                    ...
                    if (!row[U.ExcludeFromSite_col].ToBool() &&
                         row[U.FirstName_col].ToString().Trim().Length != 0 &&
                         row[U.LastName_col].ToString().Trim().Length != 0)
                    {
                        rowNumber++;
                        if (rowNumber > 4000)
        ...
        private void AddAllCemeteryRecords(DataTable VitalRecord_tbl, DataTable personTbl)
        {
            ...
            foreach (DataRow cemeteryRecordRow in CemeteryRecord_tbl.Rows)
            {
                ...
                if (String.IsNullOrEmpty(cemeteryRecordRow[U.LastName_col].ToString().Trim()) && String.IsNullOrEmpty(cemeteryRecordRow[U.FirstName_col].ToString().Trim()))
                {
                    count++;
                    continue;
                }
                ...
                string sFullName = SQL.BuildNameLastNameFirst(vitalRecordRow[U.FirstName_col].ToString().Trim(),
                                                      vitalRecordRow[U.MiddleName_col].ToString().Trim(),
                                                      vitalRecordRow[U.LastName_col].ToString().Trim(),
                                                      vitalRecordRow[U.Suffix_col].ToString().Trim(),
                                                      vitalRecordRow[U.Prefix_col].ToString().Trim(),
                                                      vitalRecordRow[U.SpouseLastName_col].ToString().Trim(),
                                                      knownAs);
                ...
                vitalRecordRow[U.BornDate_col] = !String.IsNullOrEmpty(cemeteryRecordRow[U.BornDate_col].ToString().Trim()) ? cemeteryRecordRow[U.BornDate_col].ToString().Trim() :
                ...
                vitalRecordRow[U.CemeteryName_col] = U.AbbreviatedDeathInfo(EVitalRecordType.eBurial, vitalRecordRow[U.CemeteryName_col].ToString().Trim(), vitalRecordRow[U.LotNumber_col].ToString().Trim(), vitalRecordRow[U.BornDate_col].ToString().Trim(),
                                      ...
                                      int iSortOrder)
        {
            if (iSortOrder == 1831)
            {
                ...
                WriteValue(row[U.Sex_col].ToString().Trim(), false);
                WriteValue(row[U.Book_col].ToString().Trim(), false);
                WriteValue(row[U.Page_col].ToString().Trim(), false);
                WriteValue(row[U.Notes_col].ToString().Trim(), false);

                WriteValue(row[U.BornDate_col].ToString().Trim(), false);
                WriteValue(row[U.Date_col].ToString().Trim(), false);
                WriteValue(row[U.CemeteryName_col].ToString().Trim(), false);
                WriteValue(row[U.Disposition_col].ToString().Trim(), false);
                                        ...
                                        int spouseID)
        {
            ...
            else
            {
                ...
                {
                    return spouseRow[U.LastName_col].ToString().Trim();
                }
                else
                {
                    return "";
